...
下記は ISDBScanner v1.2.1 時点でのインストール手順です。

```bash
# x86_64 環境
sudo wget https://github.com/tsukumijima/ISDBScanner/releases/download/v1.2.1/isdb-scanner -O /usr/local/bin/isdb-scanner
